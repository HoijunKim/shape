export namespace query {
	...
	export class ColumnStatsRequest {
	    handle: string;
	    path: string;
	
	    static createFrom(source: any = {}) {
	        return new ColumnStatsRequest(source);
	    }
	...
	export class ColumnStatsResult {
	    card: visual.FieldCard;
	    found: boolean;
	
	    static createFrom(source: any = {}) {
	        return new ColumnStatsResult(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.card = this.convertValues(source["card"], visual.FieldCard);
	        this.found = source["found"];
	    }
	...
	export class SaveRequest {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.format = source["format"];
	        this.outPath = source["outPath"];
	        this.edits = this.convertValues(source["edits"], CellEdit);
	    }
	...
	export class SaveResult {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.outPath = source["outPath"];
	        this.rowsOut = source["rowsOut"];
	        this.editsApplied = source["editsApplied"];
	        this.editsUnapplied = source["editsUnapplied"];
	        this.bytesOut = source["bytesOut"];
	        this.elapsedMs = source["elapsedMs"];
	        this.warnings = source["warnings"];
	    }
